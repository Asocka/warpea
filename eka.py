...
#EKA_JS
#cl = LineClient()
cl = LineClient(authToken='EJ6MSGVNhDBVW8WK5Gzf.dWMgYuaXNSPrSEaszDhmZW.B20kMu0/U2jHa2U9sCagzX3muyHTMKBabloWAjEIoCY=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EJRPpfCyhxd14rFhCMad.mTWsTkUHEqT2caPeiQt07q.KQY64yZ4eMgdAki1NVjPQpcAeLbLss6l7En+LLTOR0M=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EJwFvBqUgS0lXXBELB1c.bRNy/zqRBwNcJgquuCV9Ra.npl98slnog8ZL3LmDe4QcvqONwLChVGbGclNEDqOfMY=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='EJKlA5t2bgBGm1bVFzQe.mOsGr00YeJ/8kM/iuFsWNG.a++qDQjwmrMXCb3fvBtZQiMLe8rrisGttnzEBiz/f/k=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='EJRZ9VxDRG6iM3TXlZ06.PdRpkkJhtYRoGa70+sxlPG.tYQXB7CGe3KT5yyZMQPr0//WsTi8oqd392kk/jBHCU8=')
sw.log("Auth Token : " + str(sw.authToken))
channel11 = LineChannel(sw)
sw.log("Channel Access Token : " + str(channel11.channelAccessToken))

#js = LineClient()
js = LineClient(authToken='EJMAy5YmK7WAb6o3cX09.1hkDpQOvzoXfCHlmODgjQq.bteJhc/c92NIw4XJVFv0P22NrWqp+KDzL/ubI9ZcxI8=')
...
poll = LinePoll(cl)
call = cl
creator = ["u0f0986c940319eca51b1e01265d1cccf"]
owner = ["u0f0986c940319eca51b1e01265d1cccf"]
admin = ["u0f0986c940319eca51b1e01265d1cccf"]
staff = ["u0f0986c940319eca51b1e01265d1cccf"]
...
KAC = [cl,ki,kk,kc]
ABC = [ki,kk,kc]
Bots = [mid,Amid,Bmid,Cmid,Zmid,Jsmid]
Dpk = admin + staff
...
responsename5 = js.getProfile().displayName
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"SINI KAK GABUNG CHAT AJA mau aku cipok 😊",
    "Respontag":"SEKAARNG TAG BESOK JATUH CINTA",
    "welcome":"Selamat datang & semoga betah",
    "comment":"Like like & like by EKA FIUTAMA",
            ...
            if op.param1 in protectcancel:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    try:
                        if op.param3 not in wait["blacklist"]:
                            ki.kickoutFromGroup(op.param1,[op.param2])
                            ki.inviteIntoGroup(op.param1,[Jsmid])
                    except:
                        try:
                            if op.param3 not in wait["blacklist"]:
                                kk.kickoutFromGroup(op.param1,[op.param2])
                                kk.inviteIntoGroup(op.param1,[Jsmid])
                        except:
                            try:
                                if op.param3 not in wait["blacklist"]:
                                    kc.kickoutFromGroup(op.param1,[op.param2])
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    js.leaveGroup(op.param1,Ticket)
                                    G = cl.getGroup(op.param1)
                                    G.preventedJoinByTicket = True
                                    cl.inviteIntoGroup(op.param1,[Jsmid])
                                    Ticket = cl.reissueGroupTicket(op.param1)
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator Bot EKA FIUTAMA") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"❧GNBR  bot\n\n"+ma+"\nTotal「%s」 Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"✔admin\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」 GANABAR TEAM BOTS" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    js.inviteIntoGroup(msg.to, [Jsmid])
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "❧GNBR Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
...
#===========Protection============#
                        ...
                        elif 'Ttm ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Ttm ','')
                              if spl == 'on':
                                  if msg.to in protectantijs:
                                       msgs = "Anti Kojom Sudah diaktifin bosss"
                                  else:
                                       protectantijs.append(msg.to)
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "Anti Kojom Diaktifkan\nDi Gc : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "「Diaktifkan」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectantijs:
                                         protectantijs.remove(msg.to)
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Anti Kojom Sudah Dinonaktifkan\nDi Group : " +str(ginfo.name)
                                    else:
                                         msgs = "Anti Kojom Sudah Tidak Aktif"
                                    cl.sendMessage(msg.to, "「Dinonaktifkan」\n" + msgs)
                                    
                        elif 'Hantu ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Hantu ','')
                              if spl == 'on':
                                  if msg.to in ghost:
                                       ...
                                       ghost.append(msg.to)
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "Hantu Diaktifkan\nDi Group : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "「Diaktifkan」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in ghost:
                                         ghost.remove(msg.to)
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Hantu Dinonaktifkan\nDi Group : " +str(ginfo.name)
                                    else:
                                         msgs = "Hantu Sudah Tidak Aktif"
                                    cl.sendMessage(msg.to, "「Dinonaktifkan」\n" + msgs)                                    

                        elif 'Antikojom ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Antikojom ','')
                              if spl == 'on':
                                  if msg.to in protectqr:
                                       msgs = ""
                                  else:
                                  ...
                                  if msg.to in protectcancel:
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Semua Antikojom sudah on\nDi Group : " +str(ginfo.name)
                                  else:
                                      protectcancel.append(msg.to)
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Berhasil mengaktifkan semua Antikojom\nDi Group : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "「Diaktifkan」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectqr:
                                         protectqr.remove(msg.to)
                                    ...
                                    if msg.to in protectcancel:
                                         protectcancel.remove(msg.to)
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Berhasil menonaktifkan Antikojom\nDi Group : " +str(ginfo.name)
                                    else:
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Semua Antikojom sudah off\nDi Group : " +str(ginfo.name)
                                    cl.sendMessage(msg.to, "「Dinonaktifkan」\n" + msgs)
